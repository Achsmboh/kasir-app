    ...
    axios
      ...
      .then((res) => {
        swal({
          ...
          text: "Sukses Update Pesana" + data.product.nama,
          icon: "success",
          buttons: false,
          timer: 1500,
        });
        ...
        {keranjangs.length !== 0 && (
          <Card className="overflow-auto hasil">
            <ListGroup variant="flush">
              ...
              <ModalKeranjang handleClose={this.handleClose} {...this.state} tambah={this.tambah} kurang={this.kurang} handleSubmit={this.handleSubmit} changeHandler={this.changeHandler} hapusPesanan={this.hapusPesanan} />
            </ListGroup>
          </Card>
        )}

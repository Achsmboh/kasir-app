...
const Icon = ({ nama }) => {
  ...
  // return <FontAwesomeIcon icon={faUtensils} className="mr2" />;
};
          ...
          <ListGroup>
            {categories &&
              categories.map((category) => (
                <ListGroup.Item key={category.id} onClick={() => changeCategory(category.nama)} className={kategoriYangDipilih === category.nama && "category-aktif"} style={{ cursor: "pointer" }}>
                  <h5>
